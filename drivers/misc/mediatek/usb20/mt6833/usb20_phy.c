...
void usb_phy_recover(void)
{
	...
	/* Prize HanJiuping 20210830 modified per MTK advice adjust discth start */
	USBPHY_SET32(0x18, (0xc0<<0));
	/* Prize HanJiuping 20210830 modified per MTK advice adjust discth end */
